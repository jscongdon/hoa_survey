...
export async function POST(req: Request) {
  try {
    ...
    await sendEmail({
      ...
      html: `<p>You requested a password reset for your admin account. Click <a href="${resetUrl}">here</a> to set a new password.</p><p>This link will expire on ${expiry.toISOString()}.</p>`,
    });
