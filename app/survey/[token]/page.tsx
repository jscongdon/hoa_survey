    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-8">
      <div className="max-w-2xl mx-auto">
        <PageHeader
          ...
          subtitle={`Lot ${survey.member.lot} – ${survey.member.name}`}
        />
            ...
            <p className="text-red-700 dark:text-red-200 font-semibold">
              ...
              {survey.survey.closesAt && (
                <>
                  {" "}
                  on{" "}
                  {new Date(survey.survey.closesAt).toLocaleString(undefined, {
                    month: "long",
                    day: "numeric",
                    year: "numeric",
                    hour: "numeric",
            ...
            <p className="text-blue-600 dark:text-blue-300 text-sm">
              {survey.signed
                ...
                : `You can review and update your answers until the survey closes${
                    survey.survey.closesAt
                      ? ` on ${new Date(survey.survey.closesAt).toLocaleString(
                          undefined,
                          {
                            month: "long",
                            day: "numeric",
          ...
          {signatureRequested ? (
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">
                ...
                sign them to validate authenticity. After signing, your response
                will be finalized and can no longer be edited.
              </p>
              <button
