          ...
          {canManageAdmins && (
            <div className="flex items-center gap-3">
              ...
              <Link href="/dashboard/settings">
                <button className="px-6 py-3 bg-gray-500 hover:bg-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 text-white rounded-lg font-semibold transition-colors">
                  Back to Settings
                </button>
              </Link>
            </div>
